...
export const AuthPage: React.FC = () => {
  ...
  const [error, setError] = useState(() => {
    ...
    if (params.get('error') === 'google_failed') return 'Google sign-in failed. Please try again or use email.';
    return '';
  });
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-stone-100 p-8">
          ...
          {!googleReady && !googleLoading && (
            <a
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-2xl border-2 border-stone-200 hover:border-stone-300 bg-white hover:bg-stone-50 transition-all text-sm font-semibold text-stone-700 mt-2 no-underline"
            >
