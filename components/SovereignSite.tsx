            ...
            <div className="lg:col-span-2 space-y-10">
              ...
              {store.featuredOfferings && store.featuredOfferings.length > 0 && (
                <section>
                  ...
                  >
                    <span className="w-1.5 h-7 rounded-full inline-block flex-shrink-0" style={{ backgroundColor: brandColor }} />
                    Featured Selection
                  </h2>
              ...
              {sortedHours.length > 0 && (
                <div className="bg-white rounded-3xl border border-stone-200 shadow-sm p-6">
                  <h3 className="font-black text-stone-900 mb-4 uppercase text-xs tracking-widest flex items-center gap-2">
                    <svg className="w-4 h-4" style={{ color: brandColor }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
